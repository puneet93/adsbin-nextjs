    ...
    <div>
      ...
      <div className="flex flex-col py-5 mb-5 gap-2.5">
        ...
        <div className="flex w-full items-start md:gap-5 gap-2.5">
          ...
          <Textarea
            className="min-h-24 text-adsbin-grey-300 font-outfit font-normal placeholder:text-adsbin-grey-300 !border-adsbin-grey-200"
      ...
      <div className="flex flex-col py-5 mb-5 gap-2.5">
        <div className="flex items-center md:gap-5 gap-2.5">
          ...
          <div className="flex-grow">
            <label
              htmlFor="upload-file"
              className="text-adsbin-grey-300 font-outfit text-base font-normal flex items-center rounded-md justify-between border border-adsbin-grey-200 px-5 h-11"
            >
              <span>Select Picture</span> <Upload color="#000" />
            </label>
        ...
        <div className="flex items-center md:gap-5 gap-2.5">
          ...
          <div className="relative flex-grow">
            <Input
              type="search"
              className="text-adsbin-grey-300 font-outfit font-normal placeholder:text-adsbin-grey-300"
              placeholder="Street Address, Country, Region"
            />
            <Button
              variant={"link"}
              className="p-0 absolute top-1 right-0 min-w-16"
            >
              <Search />
            </Button>
          </div>
        ...
        <div className="flex w-full max-w-2xl items-center md:gap-5 gap-2.5">
          ...
          <Input
            type="text"
            className="text-adsbin-grey-300 w-44 font-outfit font-normal placeholder:text-adsbin-grey-300"
            placeholder="4.00"
          />
        </div>
      </div>
