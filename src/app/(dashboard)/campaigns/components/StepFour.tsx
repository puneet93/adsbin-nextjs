            ...
            <div className="flex items-center flex-wrap gap-2.5 justify-between mb-5 md:px-0 px-5">
                <div className="flex flex-wrap items-center gap-2.5">
                    <form action="/" className="relative">
                        <Input placeholder="Place search" className="rounded-sm shadow-formField text-adsbin-green-300 placeholder:text-adsbin-green-300 font-outfit text-base border-adsbin-grey-200 pr-10 font-normal min-h-10 min-w-72" />
                ...
                <div className="flex items-center gap-2.5">
                    ...
                    <Button variant={'outline'} className="text-base shadow-formField font-outfit border-adsbin-grey-200 !h-12 font-bold text-adsbin-green-300">Add All <ArrowRight color="#000" /></Button>
                </div>
            </div>
