  ...
  return (
      <>
        <Information
            ...
            label={""}
            title={
                activeIndex === 1 && "Details and Behavior" ||
                activeIndex === 2 && "Upload your advertisement" ||
                activeIndex === 3 && "QR code preferences" ||
                activeIndex === 4 && "Where do you want to show your Campaign?" ||
                activeIndex === 5 && "Set the start and end dates"
            }
            content=""
        >

          {!showPreview && (
              <div className="pt-6 px-5 relative top-2 flex items-center md:justify-end justify-center font-semibold text-xs md:ml-auto md:mr-0 mx-auto font-outfit tracking-wide leading-10">
      ...
      <div className="flex flex-col gap-2.5">
        ...
        {activeIndex <= 4 ? (
          <div className="flex items-center justify-between px-5">
            ...
            <Button className="py-2.5 px-5 text-base anim-pulse gap-2.5 h-auto bg-adsbin-green-500 rounded-none ml-auto" onClick={() => setActiveIndex(activeIndex + 1)}>
              Next step <ArrowRight className="w-5 h-5" />
            </Button>
          </div>
        ):(
