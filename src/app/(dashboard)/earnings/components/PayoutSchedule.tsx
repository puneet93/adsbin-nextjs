export default function PayoutSchedule(){
    return(
        <div className={'lg:px-8 px-5'}>
            ...
            <div className="pt-5">
                <table className="w-full table-fixed text-nowrap text-left text-base">
                    <thead>
                    ...
                    <tbody>
                        <tr className="[&>td]:py-2.5 [&>td]:px-5 [&>th]:py-2.5 [&>th]:px-5 [&>td]:text-adsbin-evergreens [&>th]:text-adsbin-evergreens border-b border-adsbin-grey-100">
                            ...
                            <th><span className={'border border-adsbin-grey-100 text-adsbin-green-500 px-2.5 py-1'}>$ 15,345.00</span></th>
                        </tr>
                        <tr className="[&>td]:py-2.5 [&>td]:px-5 [&>th]:py-2.5 [&>th]:px-5 [&>td]:text-adsbin-evergreens [&>th]:text-adsbin-evergreens border-b border-adsbin-grey-100">
                            ...
                            <th><span className={'border border-adsbin-grey-100 text-adsbin-green-500 px-2.5 py-1'}>$ 18,345.00</span></th>
                        </tr>
                        <tr className="[&>td]:py-2.5 [&>td]:px-5 [&>th]:py-2.5 [&>th]:px-5 [&>td]:text-adsbin-evergreens [&>th]:text-adsbin-evergreens border-b border-adsbin-grey-100">
                            ...
                            <th><span className={'border border-adsbin-grey-100 text-adsbin-green-500 px-2.5 py-1'}>$ 21,300.00</span></th>
                        </tr>
                        <tr className="[&>td]:py-2.5 [&>td]:px-5 [&>th]:py-2.5 [&>th]:px-5 [&>td]:text-adsbin-evergreens [&>th]:text-adsbin-evergreens border-b border-adsbin-grey-100">
                            ...
                            <th><span className={'border border-adsbin-grey-100 text-adsbin-green-500 px-2.5 py-1'}>$ 5,421.14</span></th>
                        </tr>
