...
export default function MediaUpload(){
    return(
        <div className="p-2.5">
            ...
            <label htmlFor="uploadMedia" className="border-8 text-center items-center gap-3 tracking-wider text-body font-extrabold flex flex-col border-adsbin-grey-100 p-2.5 border-dashed rounded-2xl">
