      ...
      <div className="fixed sm:right-6 right-4 left-4 sm:left-auto bottom-4 md:bottom-11 shadow-container sm:max-w-96 sm:w-full bg-white z-20">
        ...
        <div className="py-2.5 px-5 flex flex-col gap-2.5">
          <div className="flex flex-col gap-5 text-adsbin-grey-1000 font-semibold text-sm">
            <p>
              The dashboard is your central hub for managing and monitoring all
              aspects of your account. From real-time insights to performance
              metrics, it provides an at-a-glance overview of key data to help
              you make informed decisions quickly.
            </p>
            <p>
              Customize your view, track progress, and access essential tools to
              streamline your workflow—all in one convenient location. Whether
              you're checking updates or diving into detailed reports, the
              dashboard keeps you in control and on track.
            </p>
          </div>
